...
if setup:
    ...
    print("\t htc_main_mpi.py is based on mpi4py and parallelize input file preparation for different to-be-calculated materials.", end=' ')
    ...
    print("\t The command looks like: mpirun -n x python htc_main_mpi.py > htc_out 2>&, where n the number of requested cpus/cores")
    print("\t Note that normally, you can not run the above command in the login node of a super computing cluster.", end=" ")
